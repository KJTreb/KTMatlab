close all; clear; clc;
% Reconstruct benchtop images WITH PMMA CORRECTION
%calls KTThorBadPixelCorr, KTThorPanelInterp,  MgReadEviData,
%MgResliceProjectionToSinogram, MgSaveRawFile

load('20210813_Screw1/coefficients/cali_PMMA.mat')
frames = 810;
%%
...
air=KTThorBadPixelCorr(air, frames);
obj=KTThorBadPixelCorr(obj, frames);

air = KTThorPanelInterp(air);
obj = KTThorPanelInterp(obj);
